...
(function(){
    ...
    emailjs.init("YicXk2Qxd5EPe6s8I");
})();
...
function sendMail(){
            ...
            let name = "김상훈";
            let to_name = "김상훈";
            let email = "fpdlsid9539@gmail.com"
            ...
            emailjs.send("service_ohma2yq", "template_iisjubi", params).then(function(res){alert("이메일 발송이 완료되었습니다.")});
